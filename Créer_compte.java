...
public class Créer_compte {
  ...
  private void initialize() {
    ...
    label_4.setBounds(12, 361, 97, 19);
    panel.add(label_4);
    ...
    lblsiComptepargne.setBounds(177, 577, 168, 23);
    panel.add(lblsiComptepargne);
    
    JLabel label = new JLabel("Cr\u00E9ation d'un nouveau compte");
    label.setVerticalAlignment(SwingConstants.TOP);
    label.setHorizontalAlignment(SwingConstants.CENTER);
    label.setForeground(Color.DARK_GRAY);
    label.setFont(new Font("Segoe UI", Font.BOLD, 35));
    label.setBounds(21, 44, 582, 57);
    panel.add(label);
    
    JLabel label_1 = new JLabel("Num\u00E9ro Identit\u00E9 :");
    label_1.setForeground(Color.BLACK);
    label_1.setFont(new Font("Tahoma", Font.BOLD, 15));
    label_1.setBounds(10, 137, 141, 23);
    panel.add(label_1);
    
    JLabel label_2 = new JLabel("Sexe :");
    label_2.setFont(new Font("Tahoma", Font.BOLD, 15));
    label_2.setBounds(12, 413, 71, 25);
    panel.add(label_2);
    
    JLabel label_3 = new JLabel("Num\u00E9ro ID de la deuxieme personne");
    label_3.setFont(new Font("Tahoma", Font.BOLD, 15));
    label_3.setBounds(22, 544, 288, 23);
    panel.add(label_3);
    
    JLabel label_5 = new JLabel("Num\u00E9ro ID de la deuxieme personne");
    label_5.setFont(new Font("Tahoma", Font.BOLD, 15));
    label_5.setBounds(12, 522, 288, 23);
    panel.add(label_5);
    
    JLabel label_7 = new JLabel("(Si compte joint)");
    label_7.setFont(new Font("Tahoma", Font.BOLD, 15));
    label_7.setBounds(289, 522, 131, 23);
    panel.add(label_7);
    
    JLabel label_8 = new JLabel("Taux en pourcentage");
    label_8.setFont(new Font("Tahoma", Font.BOLD, 15));
    label_8.setBounds(12, 577, 160, 23);
    panel.add(label_8);
